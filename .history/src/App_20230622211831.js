...
export default function App() {
  ...
  // for change the pages to the next one
  // here i also reset my inputs after clicking on the done button
  const NextPage = () => {
  ...
  return (
    ...
    >
      {/* This is the wrapper for providing the state throughout */}
      <Wrapper.Provider
        value={{
          make,
          color,
      ...
      >
        ...
        >
          {/* This is where i handled the logic of changing the pages */}
          <div>
            {page === 0 ? (
              <Make />
            ) : page === 1 ? (
